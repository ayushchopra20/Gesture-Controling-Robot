...
; 0000 0028 // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=In Func1=In Func0=In
; 0000 0029 // State7=T State6=T State5=T State4=T State3=0 State2=T State1=T State0=T
...
; 0000 0034 // Func7=Out Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0035 // State7=0 State6=T State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 003C // Mode: Fast PWM top=0xFF
; 0000 003D // OC0 output: Non-Inverted PWM
; 0000 003E TCCR0=0x6B;
	LDI  R30,LOW(107)
	OUT  0x33,R30
...
; 0000 005B // Clock value: 125.000 kHz
; 0000 005C // Mode: Fast PWM top=0xFF
; 0000 005D // OC2 output: Non-Inverted PWM
; 0000 005E ASSR=0x00;
	OUT  0x22,R30
; 0000 005F TCCR2=0x6C;
	LDI  R30,LOW(108)
	OUT  0x25,R30
